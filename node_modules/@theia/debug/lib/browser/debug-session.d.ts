...
export declare class DebugSession implements CompositeTreeElement {
    ...
    constructor(id: string, options: DebugSessionOptions, connection: DebugSessionConnection, terminalServer: TerminalService, editorManager: EditorManager, breakpoints: BreakpointManager, labelProvider: LabelProvider, messages: MessageClient, fileService: FileService);
    dispose(): void;
