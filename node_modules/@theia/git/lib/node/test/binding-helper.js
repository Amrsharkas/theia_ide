        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, git.exec({ localUri: '' }, ['--version'])];
                case 1:
                    _b.sent(); // Enforces eager Git initialization by setting the `LOCAL_GIT_DIRECTORY` and `GIT_EXEC_PATH` env variables.
                    return [2 /*return*/, git];
            }
        });
    });
