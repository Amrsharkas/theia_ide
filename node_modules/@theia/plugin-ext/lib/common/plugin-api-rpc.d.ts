...
import { SerializedDocumentFilter, CompletionContext, MarkdownString, Range, Completion, CompletionResultDto, MarkerData, SignatureHelp, Hover, DocumentHighlight, FormattingOptions, Definition, DocumentLink, CodeLensSymbol, Command, TextEdit, DocumentSymbol, ReferenceContext, TextDocumentShowOptions, WorkspaceRootsChangeEvent, Location, Breakpoint, ColorPresentation, RenameLocation, SignatureHelpContext, CodeAction, CodeActionContext, FoldingContext, FoldingRange, SelectionRange, CallHierarchyDefinition, CallHierarchyReference, SearchInWorkspaceResult, AuthenticationSession, AuthenticationSessionsChangeEvent, AuthenticationProviderInformation, Comment, CommentOptions, CommentThreadCollapsibleState, CommentThread, CommentThreadChangedEvent } from './plugin-api-rpc-model';
...
export interface StatusBarMessageRegistryMain {
    $setMessage(id: string, text: string | undefined, priority: number, alignment: theia.StatusBarAlignment, color: string | undefined, tooltip: string | undefined, command: string | undefined, args: any[] | undefined): PromiseLike<void>;
    $dispose(id: string): void;
}
...
export declare namespace CommentsCommandArg {
    function is(arg: Object | undefined): arg is CommentsCommandArg;
}
...
export declare namespace CommentsContextCommandArg {
    function is(arg: Object | undefined): arg is CommentsContextCommandArg;
}
...
export declare namespace CommentsEditCommandArg {
    function is(arg: Object | undefined): arg is CommentsEditCommandArg;
}
...
export interface CustomEditorsExt {
    ...
    $createCustomDocument(resource: UriComponents, viewType: string, backupId: string | undefined, cancellation: CancellationToken): Promise<{
        editable: boolean;
    }>;
...
export interface DebugExt {
    ...
    $resolveDebugConfigurationWithSubstitutedVariables(debugConfiguration: theia.DebugConfiguration, workspaceFolder: string | undefined): Promise<theia.DebugConfiguration | undefined>;
