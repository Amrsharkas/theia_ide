...
var RPCProtocolImpl = /** @class */ (function () {
    function RPCProtocolImpl(connection) {
        var _this = this;
        this.locals = new Map();
    ...
    RPCProtocolImpl.prototype.remoteCall = function (proxyId, methodName, args) {
        ...
        if (cancellationToken) {
            ...
            cancellationToken.onCancellationRequested(function () {
                return _this.multiplexer.send(MessageFactory.cancel(callId));
            });
        }
    ...
    RPCProtocolImpl.prototype.receiveRequest = function (msg) {
        ...
        invocation.then(function (result) {
            ...
            _this.multiplexer.send(MessageFactory.replyOK(callId, result));
        }, function (error) {
            _this.cancellationTokenSources.delete(callId);
            _this.multiplexer.send(MessageFactory.replyErr(callId, error));
        });
    };
...
var MessageFactory = /** @class */ (function () {
    ...
    MessageFactory.request = function (req, rpcId, method, args) {
        return "{\"type\":" + 1 /* Request */ + ",\"id\":\"" + req + "\",\"proxyId\":\"" + rpcId + "\",\"method\":\"" + method + "\",\"args\":" + JSON.stringify(args, ObjectsTransferrer.replacer) + "}";
    };
    MessageFactory.replyOK = function (req, res) {
        if (typeof res === 'undefined') {
            return "{\"type\":" + 2 /* Reply */ + ",\"id\":\"" + req + "\"}";
        }
        return "{\"type\":" + 2 /* Reply */ + ",\"id\":\"" + req + "\",\"res\":" + safeStringify(res, ObjectsTransferrer.replacer) + "}";
    };
